...
export class UserService {
     ...
     */
    static async loadUserFromXml(xmlPath: string): Promise<void> {
     ...
     */
    static getUserForPermitApplication(): Record<string, any> {
     ...
     */
    static parseAddressFromBase64(base64Address: string): { city: string, street: string, houseNumber: string } {
        try {
     ...
     */
    static parseTRadresaID(base64TRadresaID: string): { street: string, city: string, houseNumber: string } {
        try {
